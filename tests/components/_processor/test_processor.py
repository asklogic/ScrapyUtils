...
#         assert p.consumer._suit.components[0].count is not 100
#         assert p.consumer._suit.components[0].count > 50
#
...
#
#         assert len(p.suit.components) == 1
#
#         [p.push(x) for x in self.faker_persons]
#         time.sleep(0.005)
#         p.exit()
...
#         suit0.process(t)
#         assert suit0.components[0].count == 1
#
#         suit1 = ProcessorSuit([normal, tar])
#         suit1.process(t)
#         assert suit1.components[0].count == 1
#         assert suit1.components[1].count == 0
#
#         suit2 = ProcessorSuit([blank])
#         suit2.process(t)
#         assert suit2.components[0].count == 1
#
#         suit3 = ProcessorSuit([blank, normal])
#         suit3.process(t)
#         assert suit3.components[0].count == 1
#         assert suit3.components[1].count == 1
#
#         suit4 = ProcessorSuit([false, blank, normal])
#         suit4.process(t)
#         assert suit4.components[0].count == 1
#         assert suit4.components[1].count == 0
#         assert suit4.components[2].count == 0
#
...
#
#         assert suit5.components[0].count == 1
#         assert suit5.components[1].count == 1
#         assert suit5.components[2].count == 0
